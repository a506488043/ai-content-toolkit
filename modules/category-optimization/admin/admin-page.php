            ...
            <div class="postbox" style="margin-top: 15px; margin-bottom: 10px;">
                <div class="inside" style="padding: 12px 15px;">
                    <div style="display: flex; align-items: center; gap: 30px; padding: 0; flex-wrap: wrap; justify-content: space-between;">
                        <div>
                            <strong><?php _e('分类总数', 'wordpress-ai-toolkit'); ?></strong>
                        ...
                        <div>
                            <strong><?php _e('有描述分类', 'wordpress-ai-toolkit'); ?></strong>
                            <div style="margin-top: 5px;">
                        ...
                        <div>
                            <strong><?php _e('无描述分类数量', 'wordpress-ai-toolkit'); ?></strong>
                            <div style="margin-top: 5px;">
                ...
                <div class="inside" style="padding: 15px;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; flex-wrap: wrap; gap: 15px;">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                            <form method="get" action="" style="display: flex; align-items: center; gap: 10px; margin: 0;">
                                <input type="hidden" name="page" value="wordpress-ai-toolkit-category-optimization">
                                <select name="status" id="category-status-filter">
                                    <option value="all" <?php selected(isset($_GET['status']) ? $_GET['status'] : 'all', 'all'); ?>><?php _e('全部分类', 'wordpress-ai-toolkit'); ?></option>
                                    <option value="with_description" <?php selected(isset($_GET['status']) ? $_GET['status'] : 'all', 'with_description'); ?>><?php _e('有描述分类', 'wordpress-ai-toolkit'); ?></option>
                                    <option value="without_description" <?php selected(isset($_GET['status']) ? $_GET['status'] : 'all', 'without_description'); ?>><?php _e('无描述分类', 'wordpress-ai-toolkit'); ?></option>
                                </select>
                                ...
                                <button type="button" id="batch-generate-descriptions" class="button button-primary">
                                    <?php _e('为无描述分类生成描述', 'wordpress-ai-toolkit'); ?>
                                </button>
                        ...
                        <div class="tablenav-pages" style="margin: 0;">
                            <?php
                            $current_url = admin_url('admin.php?page=wordpress-ai-toolkit-category-optimization');
                            if (isset($_GET['status'])) {
                                $current_url .= '&status=' . urlencode($_GET['status']);
                            }
                            ?>
                            <span class="displaying-num">
                                <?php printf(__('共 %d 个项目', 'wordpress-ai-toolkit'), $categories_list['total']); ?>
                            </span>
                            <?php
                    ...
                    if (empty($categories_list) || !isset($categories_list['categories'])) {
                        ...
                        <table class="wp-list-table widefat fixed striped">
                            <thead>
                                <tr>
                                    <th scope="col" width="30%"><?php _e('分类名称', 'wordpress-ai-toolkit'); ?></th>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="5" style="text-align: center; padding: 40px;">
                                        ...
                                        <a href="<?php echo admin_url('admin.php?page=wordpress-ai-toolkit-category-optimization'); ?>" class="button button-primary">
                                            清除筛选条件
                                        </a>
                                        <?php else: ?>
                                        <div style="font-size: 16px; color: #666; margin-bottom: 20px;">
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $category['description_length']; ?> <?php _e('字符', 'wordpress-ai-toolkit'); ?></td>
                                <td><?php echo $category['post_count']; ?> <?php _e('篇', 'wordpress-ai-toolkit'); ?></td>
                                <td>
                                    <div class="action-buttons-container">
                                        <a href="<?php echo esc_url($category['edit_url']); ?>" class="button button-small" target="_blank" style="background: #646970; color: white; border-color: #646970; margin: 0; text-decoration: none;"><?php _e('编辑', 'wordpress-ai-toolkit'); ?></a>
                                        <a href="<?php echo esc_url($category['view_url']); ?>" class="button button-small" target="_blank" style="background: #646970; color: white; border-color: #646970; margin: 0; text-decoration: none;"><?php _e('查看', 'wordpress-ai-toolkit'); ?></a>
                                        <?php if (!$category['has_description']): ?>
